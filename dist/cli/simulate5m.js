...
for (let i = 1; i <= ROUNDS; i++) {
    const rr = (0, playRound_1.playRoundBase)(config, rng);
    ...
    if (i % 2000000 === 0) {
        ...
        console.log(`[${i}/${ROUNDS}] RTP ${(rtpNow * 100).toFixed(2)}% | RPS ${Math.round(rps)}`);
    }
}
...
`;
console.log(report);
fs_1.default.writeFileSync("stats_5m.txt", report);
