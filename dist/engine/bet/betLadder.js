...
exports.BET_LADDER_CENTS = void 0;
exports.isValidBetSize = isValidBetSize;
/**
 * Alle erlaubten Bets in CENTS
 * UI darf NUR diese Werte verwenden
 */
exports.BET_LADDER_CENTS = [
    10, // 0.10
    20, // 0.20
    40, // 0.40
    60, // 0.60
...
function isValidBetSize(value) {
    return exports.BET_LADDER_CENTS.includes(value);
}
