import { WeightTable } from "../../engine/types";

// Wichtig: weights als "Zahlen", nicht Prozent. 70 statt 70%
export const wildMultBase: WeightTable<number>[] = [
  { value: 1, weight: 70.3 },
  { value: 2, weight: 12.0 },
  { value: 3, weight: 7.0 },
  { value: 5, weight: 5.1 },
...
export const wildMultExtraBet: WeightTable<number>[] = [
  { value: 1, weight: 60.0 },
  { value: 2, weight: 17.0 },
  { value: 3, weight: 9.0 },
  { value: 5, weight: 6.0 },
...
export const wildMultBonus3: WeightTable<number>[] = [
  { value: 1, weight: 62.5 },
  { value: 2, weight: 14.0 },
  { value: 3, weight: 8.0 },
  { value: 5, weight: 6.0 },
...
export const wildMultBonus4: WeightTable<number>[] = [
...
export const wildMultBonus3Buy: WeightTable<number>[] = [
...
export const wildMultBonus4Buy: WeightTable<number>[] = [
